...
<template>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="p-4 flex justify-between items-center">
            ...
            <button
                @click="toggleEditModal" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 text-sm"
            >
                Edit Profile
            </button>
        </div>
    ...
    >
        <div class="bg-white rounded-2xl shadow-lg w-full max-w-md p-6 relative">
            ...
            <!-- Modal Header -->
            <h2 class="text-xl font-semibold mb-4">BASTA PANG EDIT</h2>
